...
//일반 아이템 초기화 
HRESULT gameItem::init(string itemKey, string nameKey, string desKey, string name, int itemIdx, int cheapPrice, int reasonablePrice, int expensivePrice, int outrageousPrice, int maxCount)
{
	//전체 변수값 0으로 초기화 
...
//포션 아이템 초기화 
HRESULT gameItem::init(string itemKey, string nameKey, string desKey, string name, int itemIdx, int potionValue, int cheapPrice, int reasonablePrice, int expensivePrice, int outrageousPrice, int maxCount)
{
	//전체 변수값 0으로 초기화 
	memset(&_item, 0, sizeof(_item));
...
//장비 아이템 초기화 
HRESULT gameItem::init(string itemKey, string nameKey, string desKey, string name, ITEM type, int itemIdx, int hpValue, int atkValue, int defValue, int spdValue, int cheapPrice, int reasonablePrice, int expensivePrice, int outrageousPrice, int maxCount)
{
	//전체 변수값 0으로 초기화 
	memset(&_item, 0, sizeof(_item));
...
//일반 아이템 추가 
void itemManager::addNormalItem(string itemKey, string nameKey, string desKey, string name, int itemIdx, int cheapPrice, int reasonablePrice, int expensivePrice, int outrageousPrice, int maxCount)
{
...
//포션 아이템 추가 
void itemManager::addPotionItem(string itemKey, string nameKey, string desKey, string name, int itemIdx, int potionValue, int cheapPrice, int reasonablePrice, int expensivePrice, int outrageousPrice, int maxCount)
{
	gameItem *item = new gameItem;
...
//장비 아이템 추가 
void itemManager::addEquipmentItem(string itemKey, string nameKey, string desKey, string name, ITEM type, int itemIdx, int hpValue, int atkValue, int defValue, int spdValue, int cheapPrice, int reasonablePrice, int expensivePrice, int outrageousPrice, int maxCount)
{
	gameItem *item = new gameItem;
