...
public:
	...
	HRESULT init(string strKey, const char* fileName, bool isBGM = false, bool isLoop = false);
...
public:
	...
	void loadSound(string key, const char* fileName, bool isBGM = false, bool isLoop = false);
